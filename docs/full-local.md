...
The backend image is currently published for `linux/amd64`; Docker Desktop on
an arm64 laptop must have amd64 emulation enabled. The sandbox image itself is
multi-architecture.
