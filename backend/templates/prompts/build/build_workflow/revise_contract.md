...
The PR description is the plan document reviewers review the diff against — your revision made it stale. Before emitting your final JSON, write the revised plan to PR #{{ view.pr_number }}'s description (`gh pr edit {{ view.pr_number }} --body-file <file>`; the checkout is authenticated):
