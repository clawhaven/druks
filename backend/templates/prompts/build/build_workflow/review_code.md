...
2. **Post one PR comment** on PR #{{ view.pr_number }} (`gh pr comment {{ view.pr_number }} --body ...`; the checkout is authenticated): `Code review: <your one-sentence summary, verbatim>`.
