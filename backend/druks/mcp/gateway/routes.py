...
@router.get(
    ...
    response_model=schemas.GateDetail,
    response_model_by_alias=True,
)
async def get_gate(run_id: str) -> schemas.GateDetail:
...
@router.post(
    ...
    response_model=schemas.GateAnswerResult,
    response_model_by_alias=True,
)
async def answer_gate(run_id: str, body: schemas.AnswerGateRequest) -> schemas.GateAnswerResult:
...
async def get_agent_call(call_id: str) -> schemas.AgentCallDetail:
...
@router.get(
    ...
    response_model=schemas.AgentUsage,
    response_model_by_alias=True,
)
async def get_usage(account: Account = Depends(current_account)) -> schemas.AgentUsage:
