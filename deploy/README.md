...
The published Druks backend image is currently `linux/amd64`. Run it on an
amd64 host or a Docker environment with amd64 emulation. The separate sandbox
image is published for both amd64 and arm64.
